<div class="container-fluid pt-1 pb-2">
    <div class="row mb-2">
        <div class="col-sm-6">
            <h4 class="m-0">Fund Requsition List (Query)</h4>
        </div><!-- /.col -->
    </div><!-- /.row -->
</div>
                    ...
                    <table id="data1" class="table table-border table-striped table-sm">
                        ...
                        <tbody>
                            @foreach ($user_company as $row_table)
                                @php
                                    ...
                                    $m_fund_req_master_nf = DB::table("pro_fund_req_master_$y")
                                        ...
                                        ->where("pro_fund_req_master_$y.query_status", 1)
                            ...
                            <tr>
                                ...
                                <td>{{ "aaa" }}</td>
                                <td>
                                    <a href="{{ route('FinanceFundReqDetailQuery', [$row_fund_req_master_nf->fund_req_master_id,$row_fund_req_master_nf->company_id]) }}" class="btn btn-info btn-sm"><i class="fas fa-edit"></i></a>
                                </td>
                            </tr>
                            @endforeach
                            @endforeach
