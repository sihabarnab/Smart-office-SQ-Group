...
@section('content')
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Indent for Check</h1>
                </div><!-- /.col -->
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('CompanyFundReqCheckList') }}" method="post">
                        @csrf
                        <div class="row mb-2">
                            <div class="col-12">
                                ...
                                <tbody>
                                    @foreach ($m_fund_req_master as $key => $value)
                                        <tr>
                                            ...
                                            <td><a href="{{ route('FundReqCheck01',[$value->fund_req_master_id,$value->company_id]) }}"
