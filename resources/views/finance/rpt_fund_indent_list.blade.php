...
@section('script')
    <script>
        ...
        function getfundreqlist(company_id, form, to) {
            ...
            var k = 1;
            $.ajax({
                url: "{{ url('/get/rpt_fund_indent_list') }}/" + company_id + '/' + form + '/' + to,
                type: "GET",
                dataType: "json",
                    ...
                    $('#rpt_fund_req_list').dataTable({
                        ...
                        "columns": [{
                            ...
                            },
                            {
                                ...
                                render: function(data, type, full) {
                                    if (data.first_check == null) {
                                        ...
                                        return data.first_check + '<br>' + data
                                            .first_employee_name
                                    }
                                }
                            ...
                            },
                            {
                                ...
                                render: function(data, type, full) {
                                    if (data.second_check == null) {
                                        ...
                                        return data.second_check + '<br>' + data
                            ...
                            },
                            {
                                ...
                                render: function(data, type, full) {
                                    if (data.approved_by == null) {
                                        ...
                                        return data.approved_by + '<br>' + data
                            ...
                            },
                            {
                                data: null,
                                render: function(data, type, full) {
                                    return '<a target="_blank" href="{{ url('/') }}/finance/rpt_fund_indent_view/' +
                                        data.fund_req_master_id + '/' + data.company_id +
                                        '">view / print</a>';
                                }
                            },
                        ], // end colume
