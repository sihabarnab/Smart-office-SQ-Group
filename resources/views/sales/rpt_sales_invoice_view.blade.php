    ...
    <div class="container-fluid mt-4">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <a href="{{ route('rpt_sales_invoice_print', [$m_sales->sim_id, $m_sales->company_id]) }}"
                            ...
                            <div class="col-12">
                                ...
                                <div class="row text-right">
                                    ...
                                    <div class="col-2 font-weight-bold ">
                                        @php
                                            $discount_amount = numberFormat($m_sales->discount_amount, 2);
                                            $tr_discount_amount = numberFormat($m_sales->tr_discount_amount, 2);
                                            $transport_cost = numberFormat($m_sales->transport_cost, 2);
                                            $test_fee = numberFormat($m_sales->test_fee, 2);
                                            $other_expense = numberFormat($m_sales->other_expense, 2);
                                            $total = numberFormat($m_sales->total, 2);
