...
@section('content')
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Repair Invoice List</h1>
                </div><!-- /.col --
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    </div>
...
<script>
    ...
    <script>
        function getrrlist(company_id, form, to) {
            ...
            var k = 1;
            $.ajax({
                url: "{{ url('/get/sales/rpt_repair_invoice_list') }}/" + company_id + '/' + form + '/' + to+ '/' +
                product_group,
                type: "GET",
                dataType: "json",
                    ...
                    $('#quotation_list').dataTable({
                        ...
                        "columns": [{
                            ...
                            },
                            {
                                data: null,
                                render: function(data, type, full) {
                                    return '<a target="_blank" href="{{ url('/') }}/sales/rpt_repair_invoice_view/' +
