...
@section('script')
    ...
    <script>
        function getrrlist(company_id, form, to) {
            ...
            var k = 1;
            $.ajax({
                url: "{{ url('/get/sales/gate_pass_list') }}/" + company_id + '/' + form + '/' + to,
                type: "GET",
                dataType: "json",
                    ...
                    $('#gate_pass_list').dataTable({
                        ...
                        "columns": [{
                            ...
                            },
                            {
                                data: null,
                                render: function(data, type, full) {
                                    return data.gate_pass_master_id;
                                }
                            },
                            {
                                data: null,
                                render: function(data, type, full) {
                                    return data.delivery_chalan_master_id;
                                }
                            },
                            {
                                "data": "sim_id"
                            ...
                            },
                            {
                                data: null,
                                render: function(data, type, full) {
                                    return '<a target="_blank" href="{{ url('/') }}/sales/rpt_gate_pass_view/' +
                                        data.gate_pass_master_id + '/' + data.company_id +
                                        '">view/print</a>';
                                }
                            },
                        ], // end colume
