...
@section('script')
    ...
    <script>
        function getrrlist(company_id, form, to) {
            ...
            var k = 1;
            $.ajax({
                url: "{{ url('/get/sales/delivary_challan_list') }}/" + company_id + '/' + form + '/' + to,
                type: "GET",
                dataType: "json",
                    ...
                    $('#delivary_challan_list').dataTable({
                        ...
                        "columns": [{
                            ...
                            },
                            {
                                data: null,
                                render: function(data, type, full) {
                                    return data.delivery_chalan_master_id + '<br>' + data
                                        .dcm_date;
                                }
                            },
                            {
                            ...
                            },
                            {
                                data: null,
                                render: function(data, type, full) {
                                    return '<a target="_blank" href="{{ url('/') }}/sales/rpt_delivery_challan_view/' +
