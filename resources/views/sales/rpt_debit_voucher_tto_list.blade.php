...
@section('content')
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Debit Voucher TTO Report </h1>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    </div>
...
@section('script')
    ...
    <script>
        function getrrlist(company_id, form, to) {
            ...
            var k = 1;
            $.ajax({
                url: "{{ url('/get/sales/get_debit_voucher_tto_list') }}/" + company_id + '/' + form + '/' + to,
                type: "GET",
                dataType: "json",
                    ...
                    $('#delivary_challan_list').dataTable({
                        ...
                        "columns": [{
                            ...
                            },
                            {
                                data: null,
                                render: function(data, type, full) {
                                    return data.voucher_tto_id + "<br>" + data.voucher_tto_date;
                                }
                            },
                            {
                                data: null,
                            ...
                            },
                            {
                                data: null,
                                render: function(data, type, full) {
                                    return (data.test_fee + data.transport_fee + data
                                    .other_fee);
                                }
                            },
                            {
                                data: null,
                                render: function(data, type, full) {
                                    return '<a target="_blank" href="{{ url('/') }}/sales/rpt_debit_voucher_tto_view/' +
                                        data.voucher_tto_id + '/' + data.company_id +
                                        '">view/print</a>';
                                }
                            },
                        ], // end colume
