...
@section('content')
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Debit Voucher List </h1>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    </div>
...
@section('script')
    ...
    <script>
        function getrrlist(company_id, form, to) {
            ...
            var k = 1;
            $.ajax({
                url: "{{ url('/get/sales/get_debit_voucher_list') }}/" + company_id + '/' + form + '/' + to,
                type: "GET",
                dataType: "json",
                    ...
                    $('#delivary_challan_list').dataTable({
                        ...
                        "columns": [{
                            ...
                            },
                            {
                                data: null,
                                render: function(data, type, full) {
                                    return data.debit_voucher_id;
                                }
                            },
                            {
                                "data": "debit_voucher_date"
                            },
                            {
                                "data": "employee_name"
                            },
                            {
                                data: null,
                                render: function(data, type, full) {
                                    return '<a target="_blank" href="{{ url('/') }}/sales/rpt_debit_voucher_view/' +
                                        data.debit_voucher_id + '/' + data.company_id +
                                        '">view/print</a>';
                                }
                            },
                        ], // end colume
