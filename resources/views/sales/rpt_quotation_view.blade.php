                        ...
                        <div class="row">
                            <div class="col-12">
                                <a class="btn btn-primary float-right"
                                    href="{{ route('rpt_quotation_print',[$m_quotation_master->quotation_id,$m_quotation_master->company_id]) }}">Print</a>
                            </div>
                            <div class="col-12">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <p class="text-center">Thanking You for your business <br>
                                    If you have any quiries about this quotation please feel free to contact with
                                    us.</p>
                            </div>
                        </div>
