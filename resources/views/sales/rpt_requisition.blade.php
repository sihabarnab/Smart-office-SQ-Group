...
@section('script')
    ...
    <script>
        function getrrlist(company_id, form, to) {
            ...
            var k = 1;
            $.ajax({
                url: "{{ url('/get/sales/requisition_list') }}/" + company_id + '/' + form + '/' + to,
                type: "GET",
                dataType: "json",
                        ...
                        "columns": [{
                            ...
                            },
                            {
                                ...
                                render: function(data, type, full) {
                                    ...
                                    if (data.approved == 1) {
                                        return "Approved <br>" + approved_by;
                                    } else if (data.approved == 2) {
                                        return "Cancel <br>" + approved_by;
                                    } else {
                                        return "Pending";
                                    }
                            ...
                            },
                            {
                                data: null,
                                render: function(data, type, full) {
                                    return '<a target="_blank" href="{{ url('/') }}/sales/rpt_requisition_view/' +
