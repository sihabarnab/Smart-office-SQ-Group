...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('rpt_daliy_sales_report') }}" method="GET">
                        @csrf
                        <div class="row mb-2">
                            <div class="col-3">
                        ...
                        <table id="" class="table table-bordered table-striped table-sm">
                            ...
                            <tbody>
                                ...
                                @foreach ($sales_details as $row)
                                    @php
                                        $m_customer = DB::table('pro_customer_information')
                                            ->select(
                                                'pro_customer_information.customer_name',
                                                'pro_customer_information.customer_type',
                                            )
                        ...
                        success: function(data) {
                            ...
                            $.each(data, function(key, value) {
                                ...
                                if (m_customer_id == value.customer_id) {
                                    ...
                                    $('select[name="cbo_customer_id"]').append(
                                        '<option value="' + value.customer_id + '">' + value.customer_id+'|'+
                                        value.customer_name + '</option>');
                                }
