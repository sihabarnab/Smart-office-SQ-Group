            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="{{ route('rpt_delivery_challan_print', [$d_challan->delivery_chalan_master_id, $d_challan->company_id]) }}"
                            ...
                            <div class="col-12">
                                            ...
                                            <td>
                                                <div class="row m-0">
                                                    ...
                                                    <div class="col-6">
                                                        ...
                                                        {{ $d_challan->contract_no }} {{ $d_challan->contract_date }} <br>
                                                        {{ $d_challan->allocation_no }} {{ $d_challan->allocation_date }}
                                                    </div>
                                                </div>
                                            </td>
                                ...
                                <table class="table table-bordered table-sm mt-1">
                                    <tbody>
                                        <tr>
                                            <td>
                                                <h6 class="text-center">Marerials Described Below Carried By The Follwing
                                                    Truck Number</h6>
                                                <div class="row">
                                                    <div class="col-2"></div>
                                                    <div class="col-8">
