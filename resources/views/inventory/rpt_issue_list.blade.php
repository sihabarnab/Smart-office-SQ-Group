    ...
    <div class="container-fluid" id= 'rr'>
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <table id="rpt_requsition_issue_list" class="table table-bordered table-striped table-sm">
                            <thead>
                                <tr>
                                    <th class="text-left align-top">SL No.</th>
                                    <th class="text-left align-top">Project</th>
                                    <th class="text-left align-top">Section</th>
                                    <th class="text-left align-top">Issue No / Date</th>
                                    <th class="text-left align-top">Requisition No / Date</th>
                                    <th class="text-left align-top">Serial No / Date</th>
...
@section('script')
    ...
    <script>
        ...
        function getrrlist(company_id, form, to) {
            ...
            var k = 1;
            $.ajax({
                url: "{{ url('/get/rpt_requsition_issue_list') }}/" + company_id + '/' + form + '/' + to,
                type: "GET",
                dataType: "json",
                success: function(data) {
                    if (data) {
                        $('#loader').hide();
                        if ($.fn.DataTable.isDataTable("#rpt_requsition_issue_list")) {
                            $('#rpt_requsition_issue_list').DataTable().clear().destroy();
                        }
                    }
                    $('#rpt_requsition_issue_list').dataTable({
                        "responsive": true,
                        "lengthChange": false,
                        "autoWidth": false,
                        dom: 'Blfrtip',
                        ...
                        "columns": [{
                            ...
                            },
                            {
                                data: null,
                                render: function(data, type, full) {
                                    return data.rim_no + '<br>' + data.rim_date;
                            ...
                            },
                            {
                                data: null,
                                render: function(data, type, full) {
                                    return data.mrm_no + '<br>' + data.mrm_date;
                            ...
                            },
                            {
                                data: null,
                                render: function(data, type, full) {
                                    return data.mrm_serial_no + '<br>' + data.mrm_serial_date;
                            ...
                            },
                            {
                                data: null,
                                render: function(data, type, full) {
                                    return '<a target="_blank" href="{{ url('/') }}/inventory/rpt_requsition_issue_details/' +
                                        data.rim_no + '/' + data.company_id +
                                        '">view / print</a>';
                                }
                            },
                        ], // end colume
...
@endsection
@section('css')
    #rpt_requsition_issue_list_filter {
    width: 100px;
    float: right;
