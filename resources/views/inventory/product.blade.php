        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-body">
                    ...
                    <form id="myForm" method="post" action="{{ route('inventoryproductupdate', $m_product->product_id) }}">
                        @csrf
                        <div class="">
                            <div class="row mb-2">
                                    ...
                                    <select name="cbo_company_id" id="cbo_company_id" class="form-control">
                                        ...
                                        @foreach ($user_company as $value)
                                            <option value="{{ $value->company_id }}"
                                                {{ $value->company_id == $m_product->company_id ? 'selected' : '' }}>
                                ...
                                <div class="col-3">
                                    <select name="cbo_pg_sub_id" id="cbo_pg_sub_id" class="form-control">
                                        ...
                                        @foreach ($m_product_sub_group as $row)
                                            <option value="{{ $row->pg_sub_id }}"
                                                {{ $row->pg_sub_id == $m_product->pg_sub_id ? 'selected' : '' }}>
                                                {{ $row->pg_sub_name }}
                                            </option>
                                        @endforeach
                                    </select>
        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-body">
                    ...
                    <form id="myForm" method="post" action="{{ route('inventoryproductstore') }}">
                        @csrf
                        <div class="row mb-2">
                            <div class="col-3">
                                <select name="cbo_company_id" id="cbo_company_id" class="form-control">
...
<script>
    ...
    <script>
        function getproductinfo() {
            ...
            if (cbo_company_id) {
                $.ajax({
                    url: "{{ url('/get/product_info') }}/" + cbo_company_id,
                    type: "GET",
                    dataType: "json",
                    success: function(data) {
                        $('#product_info').dataTable({
                            ...
                            "columns": [{
                                ...
                                },
                                {
                                    data: null,
                                    render: function(data, type, full) {
                                        return '<a href="{{ url('/') }}/inventory/product/edit/' +
                                            data.product_id + '/' + cbo_company_id +
