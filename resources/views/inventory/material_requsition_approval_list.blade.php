...
@section('content')
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Material requsition list for approval</h1>
                </div><!-- /.col -->
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="card">
                <div class="card-body">
                    <form id="myForm" action="{{ route('company_wise_material_requsition_approval_list') }}" method="post">
                        @csrf
                        <div class="row mb-2">
                            <div class="col-12">
                                ...
                                <tbody>
                                    @foreach ($mr_master as $key => $value)
                                        <tr>
                                            ...
                                            <td><a href="{{ route('inventory_material_req_approval', [$value->mrm_no, $value->company_id]) }}"
