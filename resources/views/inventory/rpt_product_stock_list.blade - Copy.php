...
// date deferance stok
                                $ci_grr_details_stock  =  DB::table("pro_grr_details_$company_id")
                                ->where("product_id",$row_product_list->product_id)
                                ...
                                $ci_graw_issue_details_stock  = DB::table("pro_graw_issue_details_$company_id")
                                ->where("product_id",$row_product_list->product_id)
                                ...
                                $ci_gmaterial_return_details_stock  = DB::table("pro_gmaterial_return_details_$company_id")
                                ->where("product_id",$row_product_list->product_id)
