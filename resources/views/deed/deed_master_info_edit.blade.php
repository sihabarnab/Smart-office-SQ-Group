            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('DeedMasterInfoUpdate') }}" method="post">
                            @csrf
                        {{-- //hidden --}}
                        <input type="hidden" name="txt_deed_master_id" id="txt_deed_master_id" value="{{ $pro_deed_master->deed_master_id }}">
                            <div class="row mb-2">
                                <div class="col-3">
                                    <input type="text" class="form-control" id="txt_deed_sl"
                                        value="{{ $pro_deed_master->deed_sl }}" name="txt_deed_sl" placeholder="Serial No.">
                                    @error('txt_deed_sl')
                                ...
                                <div class="col-3">
                                    <input type="text" class="form-control" id="txt_book_no"
                                        value="{{ $pro_deed_master->book_no }}" name="txt_book_no" placeholder="Book No.">
                                    @error('txt_book_no')
                                        <div class="text-warning">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="col-3">
                                    <input type="text" class="form-control" id="txt_deed_no"
                                        value="{{ $pro_deed_master->deed_no }}" name="txt_deed_no" placeholder="Deed No.">
                                    @error('txt_deed_no')
                                        <div class="text-warning">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="col-3">
                                    <input type="text" class="form-control" id="txt_deed_date" name="txt_deed_date"
                                        placeholder="Deed Date" value="{{ $pro_deed_master->deed_date }}"
                            ...
                            <div class="row mb-2">
                                <div class="col-4">
                                    <input type="text" class="form-control" id="txt_sub_registry_bang"
                                        value="{{ $pro_deed_master->sub_registry_bang }}" name="txt_sub_registry_bang"
                                ...
                                <div class="col-4">
                                    <input type="text" class="form-control" id="txt_sub_registry_eng"
                                        value="{{ $pro_deed_master->sub_registry_eng }}" name="txt_sub_registry_eng"
                                    ...
                                    <select name="cbo_deed_type_id" id="cbo_deed_type_id" class="form-control">
                                        ...
                                        @foreach ($pro_deed_types as $pro_deed_type)
                                            <option value="{{ $pro_deed_type->deed_type_id }}"
                                                {{ $pro_deed_type->deed_type_id == $pro_deed_master->deed_type_id ? 'selected' : '' }}>
                            ...
                            <div class="row mb-2">
                                    ...
                                    <select name="cbo_division_id" id="cbo_division_id" class="form-control">
                                        ...
                                        @foreach ($pro_divisions as $pro_division)
                                            <option value="{{ $pro_division->divisions_id }}"
                                                {{ $pro_division->divisions_id == $pro_deed_master->divisions_id ? 'selected' : '' }}>
                                                {{ $pro_division->divisions_id }} | {{ $pro_division->divisions_name }} |
                                                {{ $pro_division->divisions_bn_name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-4">
                                    <select name="cbo_district_id" id="cbo_district_id" class="form-control">
                                        <option value="{{ $pro_deed_master->districts_id }}">
                                        {{ $pro_deed_master->districts_id }}|{{ $pro_deed_master->district_name }}|{{ $pro_deed_master->district_bn_name }}
                                        </option>
                                    </select>
                                ...
                                <div class="col-4">
                                    <select name="cbo_upazila_id" id="cbo_upazila_id" class="form-control">
                                        <option value="{{ $pro_deed_master->upazilas_id }}">
                                            {{ $pro_deed_master->upazilas_id }}|{{ $pro_deed_master->upazilas_name }}|{{ $pro_deed_master->upazilas_bn_name }}
                                            </option>
                                    </select>
                            ...
                            <div class="row mb-2">
                                <div class="col-6">
                                    <select name="cbo_union_id" id="cbo_union_id" class="form-control">
                                        @php
                                             $m_union = DB::table('pro_deed_master')
                                             ->join("pro_unions", "pro_deed_master.unions_id", "pro_unions.unions_id")
                                             ->where('deed_master_id', $pro_deed_master->deed_master_id)
                                             ->first()
                                        @endphp
                                        @if ($m_union)
                                        <option value="{{ $m_union->unions_id }}">
                                            {{ $m_union->unions_id }}|{{ $m_union->unions_name }}|{{ $m_union->unions_bn_name }}
                                            </option>
                                        @else
                                ...
                                <div class="col-6">
                                    <select name="cbo_mouja_id" id="cbo_mouja_id" class="form-control">
                                        <option value="{{ $pro_deed_master->moujas_id }}">
                                            {{ $pro_deed_master->moujas_id }}|{{ $pro_deed_master->moujas_name }}|{{ $pro_deed_master->moujas_bn_name }}
                                            </option>
                                    </select>
                                    @error('cbo_mouja_id')
                                        <div class="text-warning">{{ $message }}</div>
                            ...
                            <div class="row mb-2">
                                <div class="col-3">
                                    <input type="text" class="form-control" id="txt_land_area"
                                        value="{{ $pro_deed_master->land_area }}" name="txt_land_area"
                                    ...
                                    <select name="cbo_land_unit_id" id="cbo_land_unit_id" class="form-control">
                                        ...
                                        @foreach ($pro_land_units as $pro_land_unit)
                                            <option value="{{ $pro_land_unit->land_unit_id }}"
                                                {{ $pro_land_unit->land_unit_id == $pro_deed_master->land_unit_id ? 'selected' : '' }}>
                                    ...
                                    <select name="cbo_land_type_id" id="cbo_land_type_id" class="form-control">
                                        ...
                                        @foreach ($pro_land_types as $pro_land_type)
                                            <option value="{{ $pro_land_type->land_type_id }}"
                                                {{ $pro_land_type->land_type_id == $pro_deed_master->land_type_id ? 'selected' : '' }}>
                                ...
                                <div class="col-3">
                                    <input type="text" class="form-control" id="txt_land_price"
                                        value="{{ $pro_deed_master->land_price }}" name="txt_land_price"
                                        placeholder="Price">
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-2">
                                    <a href="{{ route('DeedLandOwnerEdit',$pro_deed_master->deed_master_id) }}" class="btn btn-primary btn-block">Skip</a>
                                </div>
                                @else
