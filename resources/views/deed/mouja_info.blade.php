...
@section('content')
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Moujas info<br>মৌজার তথ্য</h1>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('DeedMoujaInfoStore') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-3">
                                    <input type="text" class="form-control" id="txt_moujas_bn_name"
                                        value="{{ old('txt_moujas_bn_name') }}" name="txt_moujas_bn_name"
                                        placeholder="মৌজা">
                                    @error('txt_moujas_bn_name')
                                        <div class="text-warning">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-3">
                                    <input type="text" class="form-control" id="txt_moujas_name"
                                        value="{{ old('txt_moujas_name') }}" name="txt_moujas_name"
                                        placeholder="Mouja">
                                    @error('txt_moujas_name')
                                        <div class="text-warning">{{ $message }}</div>
                                    @enderror
