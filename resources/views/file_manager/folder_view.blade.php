...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-12">
                    <a href="{{ route('my_drive') }}" class="btn bg-green" style="width:150px;">Back</a>
                    <a href="#" class="btn bg-green ml-2" style="width:150px;float: right; " data-toggle="modal"
                        data-target="#folderModel"><strong>+</strong> Add Folder</a>
                    <a href="#" class="btn bg-green" style="width:150px;float: right; " data-toggle="modal"
                        data-target="#fileModel"><strong>+</strong> Upload File</a>
                </div>
            </div>
            <div class="card">
                <div class="card-header bg-primary">
                    <h3>{{ $m_folder->folder_name }}</h3>
                </div>
                <div class="card-body">
                                        ...
                                        <div class="card">
                                            <div class="text-right m-0">
                                                <a href="#" class="btn text-right mt-2"
                                                    ...
                                                    onclick='shr("{{ $row->folder_sub_id }}")'>
                                                    <i class="fas fa-ellipsis-v" style="font-size: 30px;"></i>
                                                </a>
                                                <ul class="list-group text-center" id="id_{{ $row->folder_sub_id }}"
                                                    style="display: none; margin-top: 15px;">
                                                    <li class="list-group-item"><a
                                                            href="{{ route('Sub_folder_delete', $row->folder_sub_id) }}">Delete</a>
                                                    </li>
                                                </ul>
                                            </div>
                                            <div class="card-body text-center" style="margin-top: -10px;">
                                                <a href="{{ route('sub_folder_view', $row->folder_sub_id) }}"
                                                    style="color: white;">
                                        ...
                                        <div class="card">
                                            <div class="text-right m-0">
                                                ...
                                                <ul class="list-group text-center" id="fid_{{ $row->file_id }}"
                                                    ...
                                                    <li class="list-group-item"><a
                                                            href="{{ route('file_delete', $row->file_id) }}">Delete</a>
                                                    </li>
                                                    <li class="list-group-item"><a
    ...
    <div class="modal fade" id="folderModel" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <form action="{{ route('folder_sub_store', $m_folder->folder_id) }}" method="post">
                    @csrf
    ...
    <div class="modal fade" id="fileModel" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <form action="{{ route('file_sub_store', $m_folder->folder_id) }}" method="post"
