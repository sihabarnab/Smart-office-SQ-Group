...
@section('content')
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Indent List For Approval</h1>
                </div><!-- /.col -->
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="card">
                <div class="card-body">
                    <form id="myForm" action="{{ route('company_wise_indent_approval') }}" method="post">
                        @csrf
                        <div class="row mb-2">
                            <div class="col-12">
                                ...
                                <tbody>
                                    @foreach ($pro_indent_master as $key => $value)
                                        <tr>
                                            ...
                                            <td class="text-left align-top">
                                                <a
                                                    href="{{ route('purchase_indent_approval', [$value->indent_no, $value->company_id]) }}">Details</a>
                                            </td>
