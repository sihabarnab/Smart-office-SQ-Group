    ...
    <div class="col-12">
      <div class="card">
        <div class="card-body">
          ...
          <form method="post" action="{{ route('HrmLeaveAppUpdate', $ci_leave_info_master->leave_info_master_id) }}">
            @csrf
            @php
            ...
            <div class="row mb-2">
              ...
              <div class="col-4">
                <input type="hidden" class="form-control" id="txt_leave_info_master_id" name="txt_leave_info_master_id" readonly value="{{ $ci_leave_info_master->leave_info_master_id }}">
            ...
            <div class="row mb-2">
              <div class="col-3">
                <select name="sele_leave_type" id="sele_leave_type" class="form-control">
                    ...
                    @foreach ($m_leave_type as $r_leave_type)
                        <option value="{{ $r_leave_type->leave_type_id }}"
                            {{ $r_leave_type->leave_type_id == $ci_leave_info_master->leave_type_id ? 'selected' : '' }}>
              ...
              <div class="col-3">
                <input type="text" class="form-control" id="txt_from_date"
                    ...
                    value="{{ $ci_leave_info_master->leave_form }}" onfocus="(this.type='date')"
              ...
              <div class="col-3">
                <input type="text" class="form-control" id="txt_to_date"
                    ...
                    value="{{ $ci_leave_info_master->leave_to }}" onfocus="(this.type='date')"
              ...
              <div class="col-3">
                <input type="text" class="form-control" id="txt_total" name="txt_total" readonly value="{{ $ci_leave_info_master->total }}">
              </div>
            </div>
            <div class="row mb-2">
              <div class="col-12">
                <input type="text" class="form-control" id="txt_purpose_leave" name="txt_purpose_leave" placeholder="Purpose Of Leave" value="{{ $ci_leave_info_master->purpose_leave }}">
...
@include('/hrm/leave_application_edit')
