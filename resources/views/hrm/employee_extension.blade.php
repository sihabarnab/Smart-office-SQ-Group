...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0">Employee Extension</h1>
      </div><!-- /.col -->
    </div><!-- /.row -->
  </div><!-- /.container-fluid -->
</div>
      ...
      <div class="card">
        <div class="card-body">
          <div align="left" class=""><h5>{{ "Add" }}</h5></div>
            <form action="{{ route('hrmemp_extensionstore') }}" method="Post">
            @csrf
            <div class="row mb-2">
              <div class="col-4">
              ...
              <div class="col-3">
                <input type="text" class="form-control" id="txt_extension" name="txt_extension" placeholder="Extension" value="{{ old('txt_extension') }}">
                  @error('txt_extension')
                    <div class="text-warning">{{ $message }}</div>
                  @enderror
              </div>
