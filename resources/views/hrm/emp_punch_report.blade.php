...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0">Employee Punch Report</h1>
      </div><!-- /.col -->
    </div><!-- /.row -->
  </div><!-- /.container-fluid -->
</div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('hrmbackdaily_punch_report') }}" method="GET">
                            @csrf
    ...
    <script type="text/javascript">
        ...
        function getEmployee() {
            ...
            if (cbo_company_id && cbo_placeofposting_id) {
                $.ajax({
                    url: "{{ url('/get/hrm/employee/') }}/" + cbo_placeofposting_id + '/' +
                    cbo_placeofposting_sub_id + '/' + cbo_company_id,
                    type: "GET",
                    dataType: "json",
                    success: function(data) {
                        console.log(data);
