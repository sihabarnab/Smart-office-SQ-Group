...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0">Leave Application Approval for Others</h1>
      </div><!-- /.col -->
    </div><!-- /.row -->
  </div><!-- /.container-fluid -->
</div>
      ...
      <div class="card">
        <div class="card-body">
          <div align="left" class=""></div>
            <form action="{{ route('leave_app_for_approval_other_update',$m_leave_info_master->leave_info_master_id) }}" method="Post">
            @csrf
            @php
            ...
            <div class="row mb-2">
              <div class="col-3">
               ...
               <input type="hidden" class="form-control" id="sele_leave_type" name="sele_leave_type" readonly value="{{ $m_leave_info_master->leave_type_id}}" >

               <input type="text" class="form-control"  readonly value="{{ $txt_leave_type }} | {{ $txt_leave_type_sname }}" >
            ...
            <div class="row mb-2">
              ...
              <div class="col-2">
                @if($ci_report->count() == 0)
                 <a href="{{route('leave_app_for_approval_upload',$m_leave_info_master->leave_info_master_id)}}" class="btn btn-primary btn-block">Continue</a>
                 @else
