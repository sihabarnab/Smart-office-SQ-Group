...
@section('content')
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form name="" method="post"
                                action="{{ route('HrmBasicInfoUpupdate', $m_basic_info->employee_info_id) }}">
                                @csrf
                                <div class="row mb-2">
                                    <div class="col-4">
                                        <input type="hidden" class="form-control" id="txt_company_id" name="txt_company_id"
                                            placeholder="" readonly value="{{ $m_basic_info->company_id }}">
                                        {{-- <input type="hidden" class="form-control" id="txt_ss" name="txt_ss"
                                            placeholder="" readonly value="{{ $m_basic_info->ss }}"> --}}
                                        <input type="hidden" class="form-control" id="txt_working_status" name="txt_working_status"
                                            placeholder="" readonly value="{{ $m_basic_info->working_status }}">
                                        <input type="hidden" class="form-control" id="txt_valid" name="txt_valid"
                                            placeholder="" readonly value="{{ $m_basic_info->valid }}">

                                        <input type="text" class="form-control" id="txt_company_name" name="txt_company_name"
                                            placeholder="" readonly value="{{ $data->company_name }}">

                                    </div>
                                    <div class="col-2">
                                        <input type="text" class="form-control"mid="txt_emp_id" name="txt_emp_id"
                                    ...
                                    <div class="col-3">
                                        <input type="text" class="form-control"mid="txt_emp_name" name="txt_emp_name"
                                            placeholder="Employee Name" readonly value="{{ $m_basic_info->employee_name }}">
                                        @error('txt_emp_name')
                                            <div class="text-warning">{{ $message }}</div>
                                        @enderror
                                    </div>
    ...
    @else
                        ...
                        <div class="card-body">
                            ...
                            <form action="" method="Post">
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-4">
                                        @php
                                            $data_pro_att_policy = DB::table('pro_att_policy')
                                                ->Where('valid', '1')
                                        ...
                                        <select name="sele_att_policy" id="sele_att_policy" class="form-control">
                                            ...
                                            @foreach ($data_pro_att_policy as $emp_att_policy)
                                                <option value="{{ $emp_att_policy->att_policy_id }}">
                                                    {{ $emp_att_policy->att_policy_name }} |
                                                    {{ $emp_att_policy->in_time }} | {{ $emp_att_policy->out_time }}
                                                </option>
                                            @endforeach
                                        </select>
                                        @error('sele_att_policy')
        ...
        @include('/hrm/basic_info_up_list')
...
@section('script')
    <script>
        window.onload = function() {
            var k = 1;
            $.ajax({
                url: "{{ url('/get/hrm/basic_info_up_list') }}/",
                type: "GET",
                dataType: "json",
                success: function(data) {
                    console.log(data);
                    $('#basic_info_up_list').dataTable({
                        "responsive": true,
                        "lengthChange": false,
                        "autoWidth": false,
                        dom: 'Blfrtip',
                        ...
                        "columns": [{
                            ...
                            },
                            {
                                data: null,
                                render: function(data, type, full) {
                                  return '<a href="{{ url('/') }}/hrm/basic_info_up/' +
                            ...
                            },
                            {
                                data: null,
                                render: function(data, type, full) {
                                  return '<a href="{{ url('/') }}/hrm/reporting_boss/' +
                                        data.employee_id + '">Report To</a>';
                                }
                            },
