                    ...
                    <table id="data1" class="table table-border table-striped table-sm">
                        ...
                        <tbody>
                            ...
                            if ($ci_employee_info->report_to_id == '0000000')
                            {
                                ...
                                $txt_report_name=$ci_employee_info_02->employee_id;
                            }
                            @endphp
                            ...
                            <tr>
                                ...
                                <td>{{ $txt_joinning_date }}/{{ $txt_att_policy_name }}/{{ $txt_yesno_name }}<BR>{{ $ci_employee_info->mobile }}/{{ $txt_blood_name }}<BR>{{ $ci_employee_info->psm_id }}</td>
