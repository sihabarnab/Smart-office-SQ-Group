          ...
          <div align="left" class="">
            ...
            <form action="{{ route('hrmbio_dataupdate',$m_employee_biodata->biodata_id) }}" method="Post">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-2">
                        <input type="text" class="form-control" id="txt_national_id_no" name="txt_national_id_no" placeholder="NID" value="{{ $m_employee_biodata->national_id_no }}">
        ...
        $(document).ready(function() {
            $('select[name="cbo_company_id"]').on('change', function() {
                ...
                if (cbo_company_id) {
                    ...
                    $.ajax({
                        url: "{{ url('/get/employee_bio/') }}/" + cbo_company_id,
                        type: "GET",
                        dataType: "json",
