                        ...
                        <table id="data1" class="table table-bordered table-striped table-sm">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-left align-top">All Posting</th>
                                    ...
                                    <tr>
                                        <form action="{{ route('user_company_update', $emp_id) }}" method="post">
                                            ...
                                            <div class="form-check">
                                                @if (isset($user_module->posting_status))
                                                    @if ($user_module->posting_status == 1)
                                                        <input class="form-check-input" type="checkbox" name="txt_posting_status"
                                                            id="txt_posting_status" checked>
                                                    @else
                                                        <input class="form-check-input" type="checkbox" name="txt_posting_status"
                                                            id="txt_posting_status">
                                                    @endif
                                                @else
                                                    <input class="form-check-input" type="checkbox" name="txt_posting_status"
                                                        id="txt_posting_status">
                                                @endif
                                                <label class="form-check-label" for="txt_posting_status">All Posting</label>
