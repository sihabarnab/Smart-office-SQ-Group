...
@section('content')
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">User Posting Permission.</h1>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{route('user_posting_permission_store')}}" method="Post">
                            @csrf
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-4">
                                    <select name="cbo_employee_id" id="cbo_employee_id" class="form-control">
                                        ...
                                        @foreach ($ci_employee_info as $value)
                                            <option value="{{ $value->employee_id }}">
                                                {{ $value->employee_id }} | {{ $value->employee_name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-4">
                                    <select name="cbo_placeofposting_id" id="cbo_placeofposting_id" class="form-control">
                                        <option value="">All Place of Posting</option>
                                        @foreach ($m_placeofposting as $emp_placeofposting)
